...
Think of it as the principal of a school.
The principal doesn't teach.
He simply saya: start today's classes."""
...
STAGE_NAME = "Data Ingestion stage"  # Start Data Ingestion Stage
try:
